...
modelo_path = os.path.join(settings.BASE_DIR, 'predictorRedNeuronal', 'modelo_base_vino.h5')
scaler_path = os.path.join(settings.BASE_DIR, 'predictorRedNeuronal', 'scaler_vino.pkl')
...
def predict_wine_quality_red_neuronal(request):
    try:
